...
import com.example.myapplicationtt.testActivity.FormActivityUpdated;
import com.example.myapplicationtt.testActivity.TestActivity;
import com.example.myapplicationtt.testActivity.TestFormActivity;
...
//
        ...
        findViewById(R.id.btn6).setOnClickListener(v ->
                startActivity(new Intent(this, FormActivityUpdated.class)));
